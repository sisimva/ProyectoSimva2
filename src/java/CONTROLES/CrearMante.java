 ...
 * @author andres
 */
@WebServlet(name = "CrearMante", urlPatterns = {"/CrearMante"})
public class CrearMante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (vehiculoDTO != null) {
                ...
                System.out.print("numero de funcionario :" + asignacionDTO.getNumeroDocumento());
