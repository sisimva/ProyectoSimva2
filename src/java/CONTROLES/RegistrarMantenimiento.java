 ...
 * @author Jairo
 */
@WebServlet(name = "RegistrarMantenimiento", urlPatterns = {"/registrarMantenimiento"})
public class RegistrarMantenimiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            mantenimiento.setFechaIngresoMantenimiento(request.getParameter("FechaI"));
            mantenimiento.setObservaciones(request.getParameter("observaciones"));
            ...
            if (placa != null) {
                ...
                idMantenimiento++;
                mantenimiento.setIdMantenimientos(idMantenimiento);
                
                
                mensaje = crearMantenimiento(mantenimiento);
            ...
            response.sendRedirect("/ProyectoSimva/spanish/mantenimiento/crearMant.jsp?Funcion="+mensaje);
