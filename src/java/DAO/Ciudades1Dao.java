...
public class Ciudades1Dao {
    ...
    public ArrayList<CiudadesDto> ConsultarTodos() {
    ...
    public String Actualizar(CiudadesDto actusu)
    {
       //boolean resul = false;
       String rta="";
        try 
        {
            stmt = con.prepareStatement("UPDATE ciudades SET idCiudad=?, nombreCiudad=?, WHERE idIudad=?;");
        
            stmt.setInt(1,actusu.getIdCiudad());
            stmt.setString(2,actusu.getNombreCiudad());
