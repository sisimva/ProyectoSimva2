...
<!-- InstanceBeginEditable name="nav" -->
    ...
    <nav>
        ...
        <a href="user.jsp" title="Gestión de usuarios"><span class="fa fa-users fa-1x"> Ingresar Usuario</a>
        <a href="usuarios_1.jsp" title="Herramientas Administrativas"><span class="fa fa-gears fa-1x"> Consultar Todos los Usuarios</a>
        <a href="usuario.jsp" title="Asignación de privilegios"><span class="fa fa-user fa-1x"> Consultar Usuario</a>
...
<!-- InstanceBeginEditable name="Body" -->
    <body>
        <section>
                ...
                <form id="formulario" action="/ProyectoSimva/ControlUsuarios">
                            <%
			...
			<label for="apellido">Apellidos:</label>
                        <input type="text" name="apellido" id="apellido" class="inputad" value='<%=miObj2.getApellido1()+" "+miObj2.getApellido2() %>' placeholder=""   tabindex="3" disabled="">
                            ...
                            <%
                            miSession.removeAttribute("cedula2");
                            if (miObj != null){
                            %>
			...
			<input type="password" name="contrasenia" id="contrasenia" class="inputad" value='<%=miObj.getContraseña()%>' placeholder="" tabindex="6" disabled="">
                        ...
                        <br>           
                        <label for="usuario">Nombre de usuario:</label>
                        <input type="text" name="usuario" id="usuario" class="inputad" value="" placeholder="" onFocus="return confirmation()" tabindex="4" onkeydown="return validarLetras(event)" />
			<br>
			<label for="rol">Rol:</label>
			<select name="rol" class="inputad"  required tabindex="5" >                        
                            <option value="100" >Administrador</option>
                            <option value="200" >Asignacion</option>
                            <option value="300" >Mantenimiento</option>
                            <option value="400" >Consulta</option>
                            <option value="500" >Conductor</option>  
                        </select>
			<br>
                            
                        <label for="contrasenia">Contraseña:</label>
			<input type="password" name="contrasenia" id="contrasenia" class="inputad"  tabindex="6" >
                        <br>
                        <label for="contraseniaC">Confirmar Contraseña:</label>
			<input type="password" name="contraseniaC" id="contraseniaC" class="inputad"  tabindex="7" >
  
                        <input type="hidden" name="fecha" id="" class="" value="2015-04-10" placeholder="" tabindex="" >
                        
                        <input class="btn btn-info" id="botenv" type="submit" name="boton" value="Enviar" onclick="return confirmation2()">
                        
                        <script type="text/javascript"> alert("Funcionario no tiene usuario asignado")</script>
                        
                        <script type="text/javascript">
                            function confirmation() {
                                    var elim = confirm('Desea Asignar un usuario Nuevo?');
                                    if (elim){
                                            alert(" Complete todos los campos");
                                            return true;
                                    } else{
                                            alert("Sera redireccionado a la pagina principal!");
                                            document.location=('/ProyectoSimva/spanish/administrador/user.jsp')
                                            return false;
                                    }
                            }
                        </script>
                         ...
                         <script type="text/javascript">
                            function confirmation2() {
                                    var elim = confirm('Si todo esta correcto oprima aceptar, de lo contrario oprima cancelar?');
                                    if (elim){
                                            alert("usuario registrado correctamente");
                                            return true;
                                    } else{
                                            alert("Verifique la informacion y vuelva oprimir el boton enviar!");
                    ...
                    <p style="text-align: center;">
                        ...
                        <form action="/ProyectoSimva/ControlUsuarios"><input class="btn btn-warning" id="botenv2" type="submit" name="boton" value="Consultar Todos" ></form>
