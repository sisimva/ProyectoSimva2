    ...
    <body>
        <section>
			...
			<h3>Digite la cédula para realizar la consulta:</h3>
                        ...
                        <input type="text" name="cedula1" id="cedula" class="inputad" value='<%=cedula%>' onFocus="return confirmation()"  placeholder="" required tabindex="1" onkeydown="return validarNumeros(event)" >
                        &nbsp;
                        <input class="btn btn-info" id="botbusc" type="submit" name="boton" value="Buscar"  onclick="">
