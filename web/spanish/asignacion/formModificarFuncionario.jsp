            ...
            <div id="area">
                ...
                <div id="miga">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Formulario Modificacion de Funcionario</li>   
                    </ol>
                </div>

                <form class="formularioModificarFuncionario" method="post" action="..\..\GestionFuncionarios">
                    <h3>Modificacion de Funcionario</h3>
