            ...
            <div id="area">
                ...
                <form class="formularioResultadoConsultaFuncionario" method="post" action="..\..\GestionFuncionarios">
                    ...
                    <div class="cajas" id="cajaUno">  
                        ...
                        <input name="numeroDocumento" id="numeroDocumento" type="text" class="inputad"  value='<%=ObjDtoFunci.getNumeroDocumento()%>' disabled="">
                        <br><br><br>
                        <label for="grado">Grado:</label>
                        
                        <Select name="grado" id="grados" type="text" class="inputad"   tabindex="3" required="">
                            <option ><%=ObjDtoFunci.getDescripcionGrado()%></option>
                        ...
                        <!--<input name="idRh" id="idRh" type="text" class="inputad" value='<%=ObjDtoFunci.getDescripcionRh()%>' disabled="">-->
                    ...
                    <div class="cajas" id="cajados">
                       ...
                       <!-- <input name="ciudadDocumento" id="ciudadDocumento" type="text" class="inputad" value= '<%=ObjDtoFunci.getNombreCiudad()%>' disabled=""> -->
                        <!--<input name="ciudadDocumento" id="ciudadDocumento" type="text" class="inputad" value= '<%=ObjDtoFunci.getIdCiudad()%>' disabled=""> -->
                        ...
                        <!--<input name="categoria" id="categoria" type="text" class="inputad" value='<%=ObjDtoFunci.getDescripcionCategoria()%>' disabled="">-->
