...
<!-- InstanceBeginEditable name="nav" -->
    ...
    <nav>	
        ...
        <a href="mantenimiento/consulMant.html" title="Consultar Fichas de Mantenimientos"><span class="fa fa-search fa-1x"></span>Consultar Ficha de Mant.</a>
        <a href="mantenimiento/editMant.html" title="Editar Fichas de Mantenimientos"><span class="fa fa-wrench fa-1x"></span>Editar Ficha de Mant.</a>
        <a href="mantenimiento/hisMan.html" title="Consultar Historial de Mantenimientos"><span class="fa fa-calendar fa-1x"></span>Consultar Historial de Mant.</a> -->
                        ...
                        <div class="ch-item">               
                            <div class="ch-info">
                                ...
                                <div class="ch-info-back">
                                   <a href="mantenimiento/consulMant.jsp"> <h3>Consultar Ficha de<br>Mantenimiento</h3> </a>
                                    <p> </p>
                                </div>  
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="ch-item">
                            <div class="ch-info">
                                ...
                                <div class="ch-info-back">
                                   <a href="mantenimiento/crearMant.jsp"> <h3>Crear Ficha<br>Mantenimiento</h3></a>
                                    <p> </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="ch-item">
                            <div class="ch-info">
                                ...
                                <div class="ch-info-back">
                                    <a href="mantenimiento/hisMan.jsp"><h3>Consulta Historial<br>Mantenimiento</h3></a>
                                    <p> </p>
                                </div>
                            </div>
                        </div>
