...
<div id="bloqueUno">
<div>
<label for="campoPlaca">Id Matenimiento:</label> 
<input name="idMantenimiento" id="campoIdMantenimiento" placeholder="000" required type="text" tabindex="1">
...
<div>
<label for="campoMantenimiento">Placa:</label>
<input name="placa" id="campoPlaca" placeholder="CJC-392" required type="text" disabled >
<div id="observacion">
<label for="observaciones">Observaciones</label>
<textarea  name="observaciones" cols=50 rows=6 id="observaciones" placeholder="Oservaciones del mantenimiento"   disabled></textarea>
</div>
</div>
</div>
