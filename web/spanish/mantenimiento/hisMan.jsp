                    ...
                    <tbody>
                        <tr>
                            <%  for (int a = 0; a < listado.size(); a++) {
                                    ...
                                    MantenimientosDto mantenimiento = listado.get(a);

                                    out.print("<td>" + mantenimiento.getIdMantenimientos() + "</td>");
                                    out.print("<td>" + mantenimiento.getPlaca() + "</td>");
                                    out.print("<td>" + mantenimiento.getFechaIngresoMantenimiento() + "</td>");
                                    out.print("<td>" + mantenimiento.getFechaSalidaMantenimiento() + "</td>");
                                    out.print("<td>" + mantenimiento.getFechaProximoMantenimiento() + "</td>");
                                    out.print("<td>" + mantenimiento.getObservaciones() + "</td>");
