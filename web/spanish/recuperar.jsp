...
<body class="login" onLoad="if ('Navigator' == navigator.appName) document.forms[0].reset();">
	...
	<div class="content">
		...
		<form class="form-vertical" action="/ProyectoSimva/GestionLogin" method="post">
			...
			<div class="form-actions">
				<button type="button"  id="back-btn" class="btn">
                                    <a href="index-es.jsp" style="text-decoration: none !important;"> <i class="m-icon-swapleft" ></i> Volver </a>
				</button>
